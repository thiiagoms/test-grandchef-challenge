...
#[OA\Schema(
    title: 'Exemplo de resposta para atualização de uma categoria via PUT',
    description: 'Modelo de resposta referente à atualização via método HTTP PUT de uma categoria',
    type: 'object',
)]
class UpdateCategoryVirtualPutResponse
{
    #[OA\Property(
        title: 'Id',
